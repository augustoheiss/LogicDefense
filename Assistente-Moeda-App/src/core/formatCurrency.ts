...
/**
 * Smart formatter — auto-selects abbreviation level based on magnitude.
 * Primary export for UI components.
 */
export const formatCurrencySmart = formatCurrencyShort;
