export interface DatasetRow {
  ...
  value: string;
  description: string;
  entryType: 'revenue' | 'expense' | 'deposit' | 'waiver' | 'partner_in' | 'partner_out';
  category: string;
  tags: string;
  metadataJson: string;
}

export function generateDataset(): DatasetRow[] {
...
export function buildCSVString(rows: DatasetRow[]): string {
